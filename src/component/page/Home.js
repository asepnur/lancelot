                        ...
                        <div className="_se _se3a">
                            ...
                            <div className="_ro">
                                <div className="_c5x34">
                                    <p className="_se5ct"><i className="fa fa-circle _i3a" aria-hidden="true"></i> YESTERDAY</p>
                                </div>
                            ...
                            <div className="_ro">
                                <div className="_c5x34">
                                    <p className="_se5ct"><i className="fa fa-circle _ic3xs" aria-hidden="true"></i> TODAY</p>
                                </div>
                                <div className="_c5x36">
                                    <p className="_se5c">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor</p>
                                </div>
                            ...
                            <div className="_ro">
                                <div className="_c5x34">
                                    <p className="_se5ct"><i className="fa fa-circle _ic3xs" aria-hidden="true"></i> SEPT 12</p>
                                </div>
                                <div className="_c5x36">
                                    <p className="_se5c">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor</p>
                                </div>
                            ...
                            <div className="_ro">
                                <div className="_c5x34">
                                    <p className="_se5ct"><i className="fa fa-circle _ic3xs _i3a" aria-hidden="true"></i> SEPT 12</p>
                                </div>
                                <div className="_c5x36">
                                    <p className="_se5c">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor</p>
                                </div>
                        ...
                        <div className="_se _se3s">
                            ...
                            <div className="_ro">
                                ...
                                <div className="_c5x33 _pd">
                                    <p className="_se5c">10.30-12.00 </p>
                                </div>
                                <div className="_c5x36">
                                    <p className="_se5c">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor</p>
                                </div>
                    ...
                    <div className="_cn _md5cu">
                        <div className="_ro">
                            <div className="_c5x312">
                                ...
                                <p className="_me3c">Lorem ipsum dolor sit amet, consectetur adipiscing elit, </p>
                            </div>
                        </div>
                        <div className="_ro">
                            <div className="_c5x312">
                        ...
                        <div className="_ro">
                            <div className="_c5x312">
                                ...
                                <InputContent type="text" name="subject" placeholder="Lorem Ipsum" onChangeState={this.onChangeState} />
                                <InputContent type="text" name="description" placeholder="Description" onChangeState={this.onChangeState} />
                            </div>
                        </div>
                        <div className="_ro">
                            <div className="_c5x312">
