            ...
            <LayoutUser>
                ...
                <div className="_ro">
                    <div className="_c5m312 _pd5m3n _ta">
                        <ul className="_ta5l">
                            <li><Link className="" id="">My Courses</Link></li>
                            <li><Link className="" id="">Manage Courses</Link></li>
                            <li><Link className="_ta5l3a" id="">Lorem Ipsum</Link></li>
                        </ul>
                    </div>
                </div>
                        ...
                        <div className="_se _se3a">
                            <div className="_ro _pd3n3b _ma3l3lr">
                                <div className="_c5x312 _c5m312 _pd3n3lr _ta">
                                    <ul className="_ta5lh">
                                        <li><Link className="_ta5l3a __btnmenu1">Basic Information</Link></li>
                                        <li><Link className="__btnmenu2">Assistant</Link></li>
                                        <li><Link className="__btnmenu3">Tutorial File</Link></li>
                                        <li><Link className="__btnmenu4">Attandance</Link></li>
                                        <li><Link className="__btnmenu5">Assignment</Link></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                            ...
                            <div className="_ro _pd3n3b">
                                <div className="_c5m36 _c5x312">
                                    <div className="_c5m35 _c5x35 _el3 _pd3m3t">
                                        <Link className="_he3b _pl3l ">Assistants</Link>
                                    </div>
                                ...
                                <div className="_c5m312 _c5x312 _pd3n3lr _ov3y _pdx3n">
                                    <table className="_tb3g">
                                        <tr>
                                            ...
                                            <td>
                                                <div>
                                                    <Link className="" href=""><i className="fa fa-pencil-square-o _ic3xs" aria-hidden="true"></i></Link>
                                                    <Link className="" href=""><i className="fa fa-times _ic3xs" aria-hidden="true"></i></Link>
                                                </div>
                                            </td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div>
                                                    <Link className="" to=""><i className="fa fa-pencil-square-o _ic3xs" aria-hidden="true"></i></Link>
                                                    <Link className="" href=""><i className="fa fa-times _ic3xs" aria-hidden="true"></i></Link>
                                                </div>
                                            </td>
                                        </tr>
                    ...
                    <div className="_c5x312 _c5m312 _pd3n3lr">
                        <div className="_se _se3a">
                            <div className="_ro _pd3n3b">
                                <div className="_c5m36 _c5x312">
                                    <div className="_c5m35 _c5x35 _el3 _pd3m3t">
                                        <Link className="_he3b _pl3l ">Tutorial File</Link>
                                    </div>
                                    <div className="_c5m36 _c5x37 _el3">
                    ...
                    <div className="_c5x312 _c5m312 _pd3n3lr">
                        <div className="_se _se3a">
                            <div className="_ro _pd3n3b">
                                <div className="_c5m36 _c5x312">
                                    <div className="_c5m35 _c5x35 _el3 _pd3m3t">
                                        <Link className="_he3b _pl3l ">Attandance</Link>
                                    </div>
                                    <div className="_c5m36 _c5x37 _el3">
                                        <button className="_bt5m3b" type="">+Create New</button>
                                    </div>
                    ...
                    <div className="_c5x312 _c5m312 _pd3n3lr">
                        <div className="_se _se3a">
                            <div className="_ro _pd3n3b">
                                <div className="_c5m36 _c5x312">
                                    <div className="_c5m35 _c5x35 _el3 _pd3m3t">
                                        <Link className="_he3b _pl3l ">Assignment</Link>
                                    </div>
                                    <div className="_c5m36 _c5x37 _el3">
                                        <button className="_bt5m3b" type="">+Create New</button>
                                    </div>
                                ...
                                <div className="_c5m312 _c5x312 _pd3n3lr _ov3y _pdx3n">
                                    <table className="_tb3g34">
                                        <tr>
                                            ...
                                            <td>
                                                <div>
                                                    <Link className="" href=""><i className="fa fa-folder-open _ic3xs" aria-hidden="true"></i></Link>
                                                    <Link className="" href=""><i className="fa fa-pencil-square-o _ic3xs" aria-hidden="true"></i></Link>
                                                    <Link className="" href=""><i className="fa fa-times _ic3xs" aria-hidden="true"></i></Link>
                                                </div>
                                            </td>
