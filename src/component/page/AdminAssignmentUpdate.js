...
class AdminAssignmentUpdate extends Component {
    ...
    handleAutoChecked = () =>{
        for (var i = 0; i < this.state.checked_typ.length; i++) {
            document.getElementById(this.state.checked_typ[i]).checked = true
        }
    ...
    handleGetDetailAssignment = () =>{
        axios.get(`/api/admin/v1/assignment/${this.state.assignment_id}?pg=1&ttl=10&payload=update`, {
            ...
            if (res.data.code === 200) {
                ...
                let lc = moment(d).local().format('YYYY-MM-DDTHH:mm:ss')
                this.setState({
                detail_loaded:true,
                                    ...
                                    <div className="_pd3n3lr _ta">
                                        <ul className="_ta5p">
                                            ...
                                            <li className="_active">
                                                <Link to={`/admin/course/${this.state.schedule_id}/update-assignment/${this.state.assignment_id}`}>Update</Link>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
    ...
    return (
        ...
        is_loaded?<div>
            ...
            <div className="_c5x312 _c5m36">
                ...
                <input value={dt.due_date} name="due_date" type="datetime-local" onChange={hdlr_asg.change}/>
            </div>
            <div className="_c5x312 _c5m36">
                <label htmlFor="description">Assignment for</label>
                <select value={dt.grade_parameter_id} name="grade_parameter_id" onChange={hdlr_asg.change}>
