...
class AdminAssignmentCreate extends Component {
    ...
    handleCreateAssignment = () => {
        ...
        moment.utc(d).format('YYYY-MM-DD HH:mm:ss')
        let lc = moment(d).local().format('YYYY-MM-DD HH:mm:ss')
        ...
        axios.post(`/api/admin/v1/assignment`, formData, {
    ...
    render() {
        ...
        const hdlr_asg = {
            ...
            createAssignment: this.handleCreateAssignment
        }
        const dt = {
                        ...
                        <div className="_cn">
                            <div className="_ro _c5m312 _c5x312 _pd5m3n">
                                ...
                                <div className="_c5x312 _c5m310  _pd3l3lr __ass">
                                    <div className="_ca">
                                        <div className="_ca3h">
                                            <div className="_c5m310 _c5x310">Create Assignment</div>
                                        </div>
    ...
    return (
        <div className="_se">
            ...
            <div className="_c5x312 _c5m36">
                ...
                <input name="due_date" type="datetime-local" onChange={hdlr_asg.change}/>
            </div>
            <div className="_c5x312 _c5m36">
                <label htmlFor="description">Assignment for</label>
                <select name="grade_parameter_id" onChange={hdlr_asg.change}>
            ...
            <div className="_c5x312 _c5m36">
                ...
                <select name="status" onChange={hdlr_asg.change}>
                    ...
                    <ul
                        ...
                        {dt.list_typ.length !== 0
                            ? dt
                                ...
                                .map((data, i) => (
                                    <li key={i}>
                                        <input value={data} type="checkbox" onChange={hdlr_asg.toggleCheck}/> {data}
                                    </li>
                                ))
                            : null
}
...
export default connect(mapStatetoProps, mapDispatchtoProps)(AdminAssignmentCreate)